...
Ensures every generated tool call conforms exactly to the Codey-OS spec
...
# Shell metacharacters that the Codey-OS shell tool blocks (mirrors shell_tools.py)
