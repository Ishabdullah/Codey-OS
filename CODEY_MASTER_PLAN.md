...
- [ ] **Concurrency test** — **Live pass RUN 2026-08-26; negative result
      ...
      **`NEW-432`**, surfaced during pre-flight (a stale resident-slot
      ...
      `NEW-434` (retry loop re-runs `/tokenize` every tick). **Checkbox
      stays unchecked — needs the mandatory live-verify pass (rule 7)
