...
- [x] **Concurrency test — CLOSED 2026-09-09, fully live-verified (see status update at the end of this entry).** — **Live pass RUN 2026-08-26; negative result
      ...
      **`NEW-432`**, surfaced during pre-flight (a stale resident-slot
      ...
      finding, `NEW-436` (a possible conservative-direction double-
      count between `/slots` occupancy and the local ledger, same
      shape as the already-accepted `NEW-208`, not yet confirmed).
      **Status update, 2026-09-09 — live-verify PASSES against the
      ...
      loop, not correctness), `NEW-436` (Suspected conservative-
      direction double-count, not yet confirmed real).
