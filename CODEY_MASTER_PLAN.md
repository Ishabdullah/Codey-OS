...
- [ ] **Concurrency test** — **Live pass RUN 2026-08-26; negative result
      ...
      **Checkbox stays unchecked — needs a live-verify pass confirming
      the second request is now genuinely ADMITTED once the pool goes
      idle** (the real NEW-435 success bar, narrower than what
      NEW-430/431 already proved) before this can close.
