...
class TestSelfModification:
    ...
    def test_read_requires_self_mod_for_code_dir(self):
        ...
        if core_file.exists():
            try:
                ...
                assert (
                    "outside workspace" in str(e).lower() or "self-modification" in str(e).lower()
                )
    ...
    def test_error_message_mentions_flag(self):
        ...
        try:
            ...
            assert (
                "--allow-self-mod" in error_lower
                or "allow_self_mod" in error_lower
                or "outside workspace" in error_lower
            )
