...
#
# Run from the codey-v3 root directory.

set -euo pipefail

CODEY_DIR="${CODEY_DIR:-$HOME/codey-v3}"
...
python3 - <<'PYEOF'
import sys, os
sys.path.insert(0, os.environ.get("CODEY_DIR", os.path.expanduser("~/codey-v3")))

from tools.kb_scraper import index_directory

skill_dir = os.path.join(os.environ.get("CODEY_DIR", os.path.expanduser("~/codey-v3")), "knowledge", "skills")
...
sys.path.insert(0, os.environ.get("CODEY_DIR", os.path.expanduser("~/codey-v3")))
from tools.kb_scraper import index_directory
docs_dir = os.path.join(os.environ.get("CODEY_DIR", os.path.expanduser("~/codey-v3")), "knowledge", "docs")
...
echo "  cp my_docs/*.md ~/codey-v3/knowledge/docs/"
