...
#
# Run from the Codey-OS root directory.

set -euo pipefail

CODEY_DIR="${CODEY_DIR:-$HOME/Codey-OS}"
...
python3 - <<'PYEOF'
import sys, os
sys.path.insert(0, os.environ.get("CODEY_DIR", os.path.expanduser("~/Codey-OS")))

from tools.kb_scraper import index_directory

skill_dir = os.path.join(os.environ.get("CODEY_DIR", os.path.expanduser("~/Codey-OS")), "knowledge", "skills")
...
sys.path.insert(0, os.environ.get("CODEY_DIR", os.path.expanduser("~/Codey-OS")))
from tools.kb_scraper import index_directory
docs_dir = os.path.join(os.environ.get("CODEY_DIR", os.path.expanduser("~/Codey-OS")), "knowledge", "docs")
...
echo "  cp my_docs/*.md ~/Codey-OS/knowledge/docs/"
