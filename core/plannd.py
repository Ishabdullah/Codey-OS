...
PLANNER_PROMPT = (
    ...
    "2. Edit step: use the format above. Include the exact filename and a specific "
    "description of what to change (e.g. 'add docstring to speak function', "
    "'fix off-by-one error in line 42', 'replace print with logger.info').\n"
    ...
    "4. Verify: describes what should be true — never a command.\n"
    "5. No two steps repeat the same action. EXCEPTION: if the user explicitly asks to run "
    ...
    "8. Never invent capabilities. Only describe what the user explicitly stated.\n"
    ...
    "EXAMPLE — user says:\n"
    "'Add a docstring to the speak function in core/voice.py'\n\n"
    "Your plan:\n"
    "1. Edit core/voice.py: add a docstring to the speak function describing its args and return value\n\n"
    "NOTE: User said 'core/voice.py'. Plan uses this exact name. Do NOT write 'voice.py' or 'core/voice'."
)
