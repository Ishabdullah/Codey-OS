...
class StrategySwitcher:
    ...
    def get_fallback(
        self, error_type: ErrorType = None, error_message: str = None
    ...
    def record_error(
        self, error_type: ErrorType, error_message: str, strategy_used: str, success: bool
    ):
        """
    ...
    def adapt_strategy(
        self, error_type: ErrorType, failed_strategy: str
    ) -> Optional[FallbackStrategy]:
        """
